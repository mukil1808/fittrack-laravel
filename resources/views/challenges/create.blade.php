...
@section('title', 'Create Challenge - FitTrack')

@section('content')

    <div class="card">
        <h1>Create Fitness Challenge</h1>
        <p>Create a challenge that users can join and participate in.</p>
    </div>
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;">
                ...
                <div style="grid-column:1 / -1;">
                    ...
                    <textarea name="description"
                              ...
                              style="width:100%;padding:12px;border:1px solid #d1d5db;border-radius:8px;resize:vertical;">{{ old('description') }}</textarea>
                </div>
