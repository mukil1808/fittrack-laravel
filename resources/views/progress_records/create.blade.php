...
@section('title', 'Add Progress - FitTrack')

@section('content')

    <div class="card">
        <h1>Add Progress Record</h1>
        <p>Record your fitness measurements and track your progress over time.</p>
    </div>
    ...
    <div class="card">
        ...
        <form action="{{ route('progress_records.store') }}" method="POST">
            @csrf
